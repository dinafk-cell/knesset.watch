  ...
  return (
    <div className="min-h-screen bg-paper" dir="rtl">
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        {aiEnabled && (
        <div className="mb-8">
          <p className="text-meta font-medium text-mute mb-2">שאל בינה מלאכותית</p>
                      ...
                      {askSources.map(s => (
                        <div key={s.sessionId} className="text-meta text-ink-2 flex items-center gap-2">
                          ...
                          <Link
                            ...
                            className="text-meta font-medium text-accent hover:underline shrink-0"
                          >
                            ←
                          </Link>
                        </div>
        ...
        <p className="text-meta font-medium text-mute mb-2">חיפוש מילות מפתח</p>
            ...
            {committees.map(c => (
              ...
              >
                ...
                <span className={`text-meta font-bold tabular-nums ${
                  selectedCommittee === c.name ? 'opacity-70' : 'text-mute'
                }`}>
                  {c.sessionCount}
                </span>
              </button>
                    ...
                    <div className="text-meta text-ink-2 leading-relaxed whitespace-pre-wrap" dir="rtl">
                      {protocol.chunks.map((chunk, i) => (
                        <div key={i} className="mb-2">
                          {chunk.speaker && (
                            <span className="font-medium text-ink">{chunk.speaker}: </span>
                          )}
